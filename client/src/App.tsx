      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          <Route element={<Layout />}>
            ...
            <Route path="/dashboard" element={<div className="p-4"><h1 className="text-2xl font-bold text-gray-900">Dashboard</h1><p className="mt-2 text-gray-600">Placeholder</p></div>} />
